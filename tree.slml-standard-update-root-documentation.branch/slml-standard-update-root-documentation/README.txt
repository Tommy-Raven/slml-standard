...
No file in this root branch defines the SLML standard.
...
A release is authoritative only when all of the following are present:
    1. semver version identifier <vX.x.patch>
    2. release tag "release--<semver><codename>
    3. commit hash SHA256
    4. release-branch name <branch-release>--<semver><codename>
...
It evaluates:
    ...
    - post-system convergences of Inconvenience displacement on a simple-manifold of TVS topology
